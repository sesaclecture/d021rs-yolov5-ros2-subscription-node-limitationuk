...
interfaces__msg__ColorDetect__init(interfaces__msg__ColorDetect * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->color_name)) {
    interfaces__msg__ColorDetect__fini(msg);
    return false;
  }
  // detect_type
  if (!rosidl_runtime_c__String__init(&msg->detect_type)) {
    interfaces__msg__ColorDetect__fini(msg);
    return false;
  }
  return true;
...
interfaces__msg__ColorDetect__fini(interfaces__msg__ColorDetect * msg)
{
  ...
  // detect_type
  rosidl_runtime_c__String__fini(&msg->detect_type);
}
  ...
  interfaces__msg__ColorDetect * output)
{
  ...
  // detect_type
  if (!rosidl_runtime_c__String__copy(
      &(input->detect_type), &(output->detect_type)))
  {
    return false;
  }
  return true;
...
interfaces__msg__ColorDetect__create(void)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  interfaces__msg__ColorDetect * msg = (interfaces__msg__ColorDetect *)allocator.allocate(sizeof(interfaces__msg__ColorDetect), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(interfaces__msg__ColorDetect));
  bool success = interfaces__msg__ColorDetect__init(msg);
  if (!success) {
...
interfaces__msg__ColorDetect__Sequence__init(interfaces__msg__ColorDetect__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  interfaces__msg__ColorDetect * data = NULL;

  if (size) {
    data = (interfaces__msg__ColorDetect *)allocator.zero_allocate(size, sizeof(interfaces__msg__ColorDetect), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = interfaces__msg__ColorDetect__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        interfaces__msg__ColorDetect__fini(&data[i - 1]);
      }
...
interfaces__msg__ColorDetect__Sequence__fini(interfaces__msg__ColorDetect__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      interfaces__msg__ColorDetect__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  interfaces__msg__ColorDetect__Sequence * array = (interfaces__msg__ColorDetect__Sequence *)allocator.allocate(sizeof(interfaces__msg__ColorDetect__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = interfaces__msg__ColorDetect__Sequence__init(array, size);
  if (!success) {
...
interfaces__msg__ColorDetect__Sequence__destroy(interfaces__msg__ColorDetect__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    interfaces__msg__ColorDetect__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
interfaces__msg__ColorDetect__Sequence__are_equal(const interfaces__msg__ColorDetect__Sequence * lhs, const interfaces__msg__ColorDetect__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!interfaces__msg__ColorDetect__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  interfaces__msg__ColorDetect__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(interfaces__msg__ColorDetect);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    interfaces__msg__ColorDetect * data =
      (interfaces__msg__ColorDetect *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!interfaces__msg__ColorDetect__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          interfaces__msg__ColorDetect__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!interfaces__msg__ColorDetect__copy(
