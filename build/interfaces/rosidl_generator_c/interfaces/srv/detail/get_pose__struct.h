...
enum
{
  interfaces__srv__GetPose_Event__request__MAX_SIZE = 1
};
// response
enum
{
  interfaces__srv__GetPose_Event__response__MAX_SIZE = 1
};

/// Struct defined in srv/GetPose in the package interfaces.
typedef struct interfaces__srv__GetPose_Event
{
  service_msgs__msg__ServiceEventInfo info;
  interfaces__srv__GetPose_Request__Sequence request;
  interfaces__srv__GetPose_Response__Sequence response;
} interfaces__srv__GetPose_Event;

// Struct for a sequence of interfaces__srv__GetPose_Event.
typedef struct interfaces__srv__GetPose_Event__Sequence
{
