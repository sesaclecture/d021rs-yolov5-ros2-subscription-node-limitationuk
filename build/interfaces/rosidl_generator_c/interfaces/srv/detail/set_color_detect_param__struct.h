...
enum
{
  interfaces__srv__SetColorDetectParam_Event__request__MAX_SIZE = 1
};
// response
enum
{
  interfaces__srv__SetColorDetectParam_Event__response__MAX_SIZE = 1
};

/// Struct defined in srv/SetColorDetectParam in the package interfaces.
typedef struct interfaces__srv__SetColorDetectParam_Event
{
  service_msgs__msg__ServiceEventInfo info;
  interfaces__srv__SetColorDetectParam_Request__Sequence request;
  interfaces__srv__SetColorDetectParam_Response__Sequence response;
} interfaces__srv__SetColorDetectParam_Event;

// Struct for a sequence of interfaces__srv__SetColorDetectParam_Event.
typedef struct interfaces__srv__SetColorDetectParam_Event__Sequence
{
