...
bool cdr_serialize_interfaces__srv__SetPose_Request(
  const interfaces__srv__SetPose_Request * ros_message,
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_interfaces
bool cdr_deserialize_interfaces__srv__SetPose_Request(
  eprosima::fastcdr::Cdr & cdr,
  interfaces__srv__SetPose_Request * ros_message)
{
  // Field name: position
  {
    uint32_t cdrSize;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_interfaces
bool cdr_serialize_key_interfaces__srv__SetPose_Request(
  const interfaces__srv__SetPose_Request * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: position
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_interfaces
size_t get_serialized_size_key_interfaces__srv__SetPose_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SetPose_Request__ros_msg_type * ros_message = static_cast<const _SetPose_Request__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_interfaces
size_t max_serialized_size_key_interfaces__srv__SetPose_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const interfaces__srv__SetPose_Request * ros_message = static_cast<const interfaces__srv__SetPose_Request *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_interfaces__srv__SetPose_Request(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  interfaces__srv__SetPose_Request * ros_message = static_cast<interfaces__srv__SetPose_Request *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_interfaces__srv__SetPose_Request(cdr, ros_message);
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_interfaces
bool cdr_serialize_interfaces__srv__SetPose_Response(
  const interfaces__srv__SetPose_Response * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: success
  {
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_interfaces
bool cdr_deserialize_interfaces__srv__SetPose_Response(
  eprosima::fastcdr::Cdr & cdr,
  interfaces__srv__SetPose_Response * ros_message)
{
  // Field name: success
  {
    uint8_t tmp;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_interfaces
bool cdr_serialize_key_interfaces__srv__SetPose_Response(
  const interfaces__srv__SetPose_Response * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: success
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_interfaces
size_t get_serialized_size_key_interfaces__srv__SetPose_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SetPose_Response__ros_msg_type * ros_message = static_cast<const _SetPose_Response__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_interfaces
size_t max_serialized_size_key_interfaces__srv__SetPose_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const interfaces__srv__SetPose_Response * ros_message = static_cast<const interfaces__srv__SetPose_Response *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_interfaces__srv__SetPose_Response(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  interfaces__srv__SetPose_Response * ros_message = static_cast<interfaces__srv__SetPose_Response *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_interfaces__srv__SetPose_Response(cdr, ros_message);
}
...
using _SetPose_Event__ros_msg_type = interfaces__srv__SetPose_Event;


ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_interfaces
bool cdr_serialize_interfaces__srv__SetPose_Event(
  const interfaces__srv__SetPose_Event * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: info
  {
  ...
  // Field name: request
  {
    ...
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_interfaces__srv__SetPose_Request(
        &array_ptr[i], cdr);
    }
  }
  ...
  // Field name: response
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_interfaces__srv__SetPose_Response(
        &array_ptr[i], cdr);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_interfaces
bool cdr_deserialize_interfaces__srv__SetPose_Event(
  eprosima::fastcdr::Cdr & cdr,
  interfaces__srv__SetPose_Event * ros_message)
{
  // Field name: info
  {
  ...
  // Field name: request
  {
    ...
    if (ros_message->request.data) {
      interfaces__srv__SetPose_Request__Sequence__fini(&ros_message->request);
    }
    if (!interfaces__srv__SetPose_Request__Sequence__init(&ros_message->request, size)) {
      fprintf(stderr, "failed to create array for field 'request'");
      return false;
    }
    auto array_ptr = ros_message->request.data;
    for (size_t i = 0; i < size; ++i) {
      cdr_deserialize_interfaces__srv__SetPose_Request(cdr, &array_ptr[i]);
    }
  }
  ...
  // Field name: response
  {
    ...
    if (ros_message->response.data) {
      interfaces__srv__SetPose_Response__Sequence__fini(&ros_message->response);
    }
    if (!interfaces__srv__SetPose_Response__Sequence__init(&ros_message->response, size)) {
      fprintf(stderr, "failed to create array for field 'response'");
      return false;
    }
    auto array_ptr = ros_message->response.data;
    for (size_t i = 0; i < size; ++i) {
      cdr_deserialize_interfaces__srv__SetPose_Response(cdr, &array_ptr[i]);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_interfaces
size_t get_serialized_size_interfaces__srv__SetPose_Event(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  ...
  // Field name: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_interfaces__srv__SetPose_Request(
  ...
  // Field name: response
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_interfaces__srv__SetPose_Response(
        &array_ptr[index], current_alignment);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_interfaces
size_t max_serialized_size_interfaces__srv__SetPose_Event(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Field name: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_interfaces__srv__SetPose_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Field name: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_interfaces__srv__SetPose_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = interfaces__srv__SetPose_Event;
    is_plain =
      (
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_interfaces
bool cdr_serialize_key_interfaces__srv__SetPose_Event(
  const interfaces__srv__SetPose_Event * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: info
  ...
  // Field name: request
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_key_interfaces__srv__SetPose_Request(
        &array_ptr[i], cdr);
    }
  }
  ...
  // Field name: response
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_key_interfaces__srv__SetPose_Response(
        &array_ptr[i], cdr);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_interfaces
size_t get_serialized_size_key_interfaces__srv__SetPose_Event(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SetPose_Event__ros_msg_type * ros_message = static_cast<const _SetPose_Event__ros_msg_type *>(untyped_ros_message);
  ...
  // Field name: request
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_key_interfaces__srv__SetPose_Request(
        &array_ptr[index], current_alignment);
    }
  }
  ...
  // Field name: response
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_key_interfaces__srv__SetPose_Response(
        &array_ptr[index], current_alignment);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_interfaces
size_t max_serialized_size_key_interfaces__srv__SetPose_Event(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Field name: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_interfaces__srv__SetPose_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Field name: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_interfaces__srv__SetPose_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const interfaces__srv__SetPose_Event * ros_message = static_cast<const interfaces__srv__SetPose_Event *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_interfaces__srv__SetPose_Event(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  interfaces__srv__SetPose_Event * ros_message = static_cast<interfaces__srv__SetPose_Event *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_interfaces__srv__SetPose_Event(cdr, ros_message);
}

static uint32_t _SetPose_Event__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_interfaces__srv__SetPose_Event(
      untyped_ros_message, 0));
}
...
static size_t _SetPose_Event__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_interfaces__srv__SetPose_Event(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, interfaces, srv, SetPose_Event)() {
