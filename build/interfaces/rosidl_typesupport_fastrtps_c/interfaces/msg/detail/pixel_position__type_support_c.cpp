  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const interfaces__msg__PixelPosition * ros_message = static_cast<const interfaces__msg__PixelPosition *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_interfaces__msg__PixelPosition(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  interfaces__msg__PixelPosition * ros_message = static_cast<interfaces__msg__PixelPosition *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_interfaces__msg__PixelPosition(cdr, ros_message);
}
