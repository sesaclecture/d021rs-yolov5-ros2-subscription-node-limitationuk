...
#include "interfaces/msg/detail/object_info__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/primitives_sequence.h"  // box
#include "rosidl_runtime_c/primitives_sequence_functions.h"  // box
...
using _ObjectInfo__ros_msg_type = interfaces__msg__ObjectInfo;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = interfaces__msg__ObjectInfo;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const interfaces__msg__ObjectInfo * ros_message = static_cast<const interfaces__msg__ObjectInfo *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_interfaces__msg__ObjectInfo(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  interfaces__msg__ObjectInfo * ros_message = static_cast<interfaces__msg__ObjectInfo *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_interfaces__msg__ObjectInfo(cdr, ros_message);
}

static uint32_t _ObjectInfo__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_interfaces__msg__ObjectInfo(
...
static size_t _ObjectInfo__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_interfaces__msg__ObjectInfo(
