...
void GetPose_Event_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) interfaces::srv::GetPose_Event(_init);
}

void GetPose_Event_fini_function(void * message_memory)
{
  auto typed_message = static_cast<interfaces::srv::GetPose_Event *>(message_memory);
  typed_message->~GetPose_Event();
}

size_t size_function__GetPose_Event__request(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<interfaces::srv::GetPose_Request> *>(untyped_member);
  return member->size();
}
...
{
  const auto & member =
    *reinterpret_cast<const std::vector<interfaces::srv::GetPose_Request> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::vector<interfaces::srv::GetPose_Request> *>(untyped_member);
  return &member[index];
}
...
void fetch_function__GetPose_Event__request(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const interfaces::srv::GetPose_Request *>(
    get_const_function__GetPose_Event__request(untyped_member, index));
  auto & value = *reinterpret_cast<interfaces::srv::GetPose_Request *>(untyped_value);
  value = item;
}
...
void assign_function__GetPose_Event__request(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<interfaces::srv::GetPose_Request *>(
    get_function__GetPose_Event__request(untyped_member, index));
  const auto & value = *reinterpret_cast<const interfaces::srv::GetPose_Request *>(untyped_value);
  item = value;
}
...
{
  const auto * member = reinterpret_cast<const std::vector<interfaces::srv::GetPose_Response> *>(untyped_member);
  return member->size();
}
...
{
  const auto & member =
    *reinterpret_cast<const std::vector<interfaces::srv::GetPose_Response> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::vector<interfaces::srv::GetPose_Response> *>(untyped_member);
  return &member[index];
}
...
void fetch_function__GetPose_Event__response(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const interfaces::srv::GetPose_Response *>(
    get_const_function__GetPose_Event__response(untyped_member, index));
  auto & value = *reinterpret_cast<interfaces::srv::GetPose_Response *>(untyped_value);
  value = item;
}
...
void assign_function__GetPose_Event__response(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<interfaces::srv::GetPose_Response *>(
    get_function__GetPose_Event__response(untyped_member, index));
  const auto & value = *reinterpret_cast<const interfaces::srv::GetPose_Response *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember GetPose_Event_message_member_array[3] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(interfaces::srv::GetPose_Event, info),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<interfaces::srv::GetPose_Request>(),  // members of sub message
    false,  // is key
    true,  // is array
    1,  // array size
    true,  // is upper bound
    offsetof(interfaces::srv::GetPose_Event, request),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<interfaces::srv::GetPose_Response>(),  // members of sub message
    false,  // is key
    true,  // is array
    1,  // array size
    true,  // is upper bound
    offsetof(interfaces::srv::GetPose_Event, response),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers GetPose_Event_message_members = {
  ...
  3,  // number of fields
  sizeof(interfaces::srv::GetPose_Event),
  false,  // has_any_key_member_
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
get_message_type_support_handle<interfaces::srv::GetPose_Event>()
{
  return &::interfaces::srv::rosidl_typesupport_introspection_cpp::GetPose_Event_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, interfaces, srv, GetPose_Event)() {
  return &::interfaces::srv::rosidl_typesupport_introspection_cpp::GetPose_Event_message_type_support_handle;
}
...
static const rosidl_service_type_support_t GetPose_service_type_support_handle = {
  ...
  ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<interfaces::srv::GetPose_Request>(),
  ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<interfaces::srv::GetPose_Response>(),
  ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<interfaces::srv::GetPose_Event>(),
  &::rosidl_typesupport_cpp::service_create_event_message<interfaces::srv::GetPose>,
  &::rosidl_typesupport_cpp::service_destroy_event_message<interfaces::srv::GetPose>,
