...
{
  const auto * member = reinterpret_cast<const std::vector<interfaces::msg::PixelPosition> *>(untyped_member);
  return member->size();
}
...
{
  const auto & member =
    *reinterpret_cast<const std::vector<interfaces::msg::PixelPosition> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::vector<interfaces::msg::PixelPosition> *>(untyped_member);
  return &member[index];
}
...
{
  const auto & item = *reinterpret_cast<const interfaces::msg::PixelPosition *>(
    get_const_function__Points__points(untyped_member, index));
  auto & value = *reinterpret_cast<interfaces::msg::PixelPosition *>(untyped_value);
  value = item;
}
...
{
  auto & item = *reinterpret_cast<interfaces::msg::PixelPosition *>(
    get_function__Points__points(untyped_member, index));
  const auto & value = *reinterpret_cast<const interfaces::msg::PixelPosition *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Points_message_member_array[1] = {
  {
    "points",  // name
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<interfaces::msg::PixelPosition>(),  // members of sub message
    false,  // is key
    true,  // is array
    0,  // array size
