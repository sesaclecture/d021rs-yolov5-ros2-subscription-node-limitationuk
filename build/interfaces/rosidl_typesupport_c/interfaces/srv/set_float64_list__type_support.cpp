...
static const _SetFloat64List_Request_type_support_symbol_names_t _SetFloat64List_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, interfaces, srv, SetFloat64List_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, interfaces, srv, SetFloat64List_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, interfaces, srv, SetFloat64List_Request)() {
  return &::interfaces::srv::rosidl_typesupport_c::SetFloat64List_Request_message_type_support_handle;
}
...
static const _SetFloat64List_Response_type_support_symbol_names_t _SetFloat64List_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, interfaces, srv, SetFloat64List_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, interfaces, srv, SetFloat64List_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, interfaces, srv, SetFloat64List_Response)() {
  return &::interfaces::srv::rosidl_typesupport_c::SetFloat64List_Response_message_type_support_handle;
}
...
typedef struct _SetFloat64List_Event_type_support_ids_t
{
  const char * typesupport_identifier[2];
} _SetFloat64List_Event_type_support_ids_t;

static const _SetFloat64List_Event_type_support_ids_t _SetFloat64List_Event_message_typesupport_ids = {
  {
    "rosidl_typesupport_fastrtps_c",  // ::rosidl_typesupport_fastrtps_c::typesupport_identifier,
    "rosidl_typesupport_introspection_c",  // ::rosidl_typesupport_introspection_c::typesupport_identifier,
  }
...
typedef struct _SetFloat64List_Event_type_support_symbol_names_t
{
  const char * symbol_name[2];
} _SetFloat64List_Event_type_support_symbol_names_t;

#define STRINGIFY_(s) #s
#define STRINGIFY(s) STRINGIFY_(s)

static const _SetFloat64List_Event_type_support_symbol_names_t _SetFloat64List_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, interfaces, srv, SetFloat64List_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, interfaces, srv, SetFloat64List_Event)),
  }
};

typedef struct _SetFloat64List_Event_type_support_data_t
{
  void * data[2];
} _SetFloat64List_Event_type_support_data_t;

static _SetFloat64List_Event_type_support_data_t _SetFloat64List_Event_message_typesupport_data = {
  {
    0,  // will store the shared library later
    0,  // will store the shared library later
  }
...
static const type_support_map_t _SetFloat64List_Event_message_typesupport_map = {
  2,
  "interfaces",
  &_SetFloat64List_Event_message_typesupport_ids.typesupport_identifier[0],
  &_SetFloat64List_Event_message_typesupport_symbol_names.symbol_name[0],
  &_SetFloat64List_Event_message_typesupport_data.data[0],
};

static const rosidl_message_type_support_t SetFloat64List_Event_message_type_support_handle = {
  rosidl_typesupport_c__typesupport_identifier,
  reinterpret_cast<const type_support_map_t *>(&_SetFloat64List_Event_message_typesupport_map),
  rosidl_typesupport_c__get_message_typesupport_handle_function,
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, interfaces, srv, SetFloat64List_Event)() {
  return &::interfaces::srv::rosidl_typesupport_c::SetFloat64List_Event_message_type_support_handle;
}
...
static const _SetFloat64List_type_support_symbol_names_t _SetFloat64List_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, interfaces, srv, SetFloat64List)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, interfaces, srv, SetFloat64List)),
  }
};
...
static const rosidl_service_type_support_t SetFloat64List_service_type_support_handle = {
  ...
  &SetFloat64List_Request_message_type_support_handle,
  &SetFloat64List_Response_message_type_support_handle,
  &SetFloat64List_Event_message_type_support_handle,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, interfaces, srv, SetFloat64List)() {
  return &::interfaces::srv::rosidl_typesupport_c::SetFloat64List_service_type_support_handle;
}
