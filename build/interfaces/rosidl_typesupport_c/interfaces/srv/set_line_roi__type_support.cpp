...
static const _SetLineROI_Event_type_support_symbol_names_t _SetLineROI_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, interfaces, srv, SetLineROI_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, interfaces, srv, SetLineROI_Event)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, interfaces, srv, SetLineROI_Event)() {
  return &::interfaces::srv::rosidl_typesupport_c::SetLineROI_Event_message_type_support_handle;
}
...
static const rosidl_service_type_support_t SetLineROI_service_type_support_handle = {
  ...
  &SetLineROI_Request_message_type_support_handle,
  &SetLineROI_Response_message_type_support_handle,
  &SetLineROI_Event_message_type_support_handle,
