...
class SetPose_Event(metaclass=Metaclass_SetPose_Event):
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<interfaces/SetPose_Request, 1>',
        'response': 'sequence<interfaces/SetPose_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['interfaces', 'srv'], 'SetPose_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['interfaces', 'srv'], 'SetPose_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from interfaces.srv import SetPose_Request
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
    ...
    def response(self, value):
        if self._check_fields:
            from interfaces.srv import SetPose_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
...
class SetPose(metaclass=Metaclass_SetPose):
    ...
    from interfaces.srv._set_pose import SetPose_Event as Event
