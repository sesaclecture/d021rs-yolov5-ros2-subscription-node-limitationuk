...
class GetPose_Event(metaclass=Metaclass_GetPose_Event):
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<interfaces/GetPose_Request, 1>',
        'response': 'sequence<interfaces/GetPose_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['interfaces', 'srv'], 'GetPose_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['interfaces', 'srv'], 'GetPose_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from interfaces.srv import GetPose_Request
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
    ...
    def response(self, value):
        if self._check_fields:
            from interfaces.srv import GetPose_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
...
class Metaclass_GetPose(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from interfaces.srv import _get_pose
...
class GetPose(metaclass=Metaclass_GetPose):
    from interfaces.srv._get_pose import GetPose_Request as Request
    from interfaces.srv._get_pose import GetPose_Response as Response
    from interfaces.srv._get_pose import GetPose_Event as Event
