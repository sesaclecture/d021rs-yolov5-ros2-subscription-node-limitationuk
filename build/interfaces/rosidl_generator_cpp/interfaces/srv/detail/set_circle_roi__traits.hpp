...
inline std::string to_yaml(const SetCircleROI_Event & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
...
[[deprecated("use interfaces::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const interfaces::srv::SetCircleROI_Event & msg,
  std::ostream & out, size_t indentation = 0)
{
  interfaces::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use interfaces::srv::to_yaml() instead")]]
inline std::string to_yaml(const interfaces::srv::SetCircleROI_Event & msg)
{
  return interfaces::srv::to_yaml(msg);
}

template<>
inline const char * data_type<interfaces::srv::SetCircleROI_Event>()
{
  return "interfaces::srv::SetCircleROI_Event";
}

template<>
inline const char * name<interfaces::srv::SetCircleROI_Event>()
{
  return "interfaces/srv/SetCircleROI_Event";
}

template<>
struct has_fixed_size<interfaces::srv::SetCircleROI_Event>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<interfaces::srv::SetCircleROI_Event>
  : std::integral_constant<bool, has_bounded_size<interfaces::srv::SetCircleROI_Request>::value && has_bounded_size<interfaces::srv::SetCircleROI_Response>::value && has_bounded_size<service_msgs::msg::ServiceEventInfo>::value> {};

template<>
struct is_message<interfaces::srv::SetCircleROI_Event>
  : std::true_type {};
