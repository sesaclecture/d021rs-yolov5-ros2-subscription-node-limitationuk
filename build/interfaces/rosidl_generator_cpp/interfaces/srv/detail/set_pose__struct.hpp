...
// IWYU pragma: private, include "interfaces/srv/set_pose.hpp"
...
#ifndef _WIN32
# define DEPRECATED__interfaces__srv__SetPose_Event __attribute__((deprecated))
#else
# define DEPRECATED__interfaces__srv__SetPose_Event __declspec(deprecated)
#endif
...
struct SetPose_Event_
{
  ...
  _info_type info;
  using _request_type =
    rosidl_runtime_cpp::BoundedVector<interfaces::srv::SetPose_Request_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<interfaces::srv::SetPose_Request_<ContainerAllocator>>>;
  _request_type request;
  using _response_type =
    rosidl_runtime_cpp::BoundedVector<interfaces::srv::SetPose_Response_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<interfaces::srv::SetPose_Response_<ContainerAllocator>>>;
  ...
  Type & set__request(
    const rosidl_runtime_cpp::BoundedVector<interfaces::srv::SetPose_Request_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<interfaces::srv::SetPose_Request_<ContainerAllocator>>> & _arg)
  {
    this->request = _arg;
    return *this;
  }
  Type & set__response(
    const rosidl_runtime_cpp::BoundedVector<interfaces::srv::SetPose_Response_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<interfaces::srv::SetPose_Response_<ContainerAllocator>>> & _arg)
  {
    this->response = _arg;
    return *this;
  }
  ...
  // pointer types
  using RawPtr =
    interfaces::srv::SetPose_Event_<ContainerAllocator> *;
  using ConstRawPtr =
    const interfaces::srv::SetPose_Event_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<interfaces::srv::SetPose_Event_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<interfaces::srv::SetPose_Event_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      interfaces::srv::SetPose_Event_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<interfaces::srv::SetPose_Event_<ContainerAllocator>, Deleter>;
  ...
  template<typename Deleter = std::default_delete<
      interfaces::srv::SetPose_Event_<ContainerAllocator>>>
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<interfaces::srv::SetPose_Event_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<interfaces::srv::SetPose_Event_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<interfaces::srv::SetPose_Event_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__interfaces__srv__SetPose_Event
    std::shared_ptr<interfaces::srv::SetPose_Event_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__interfaces__srv__SetPose_Event
    std::shared_ptr<interfaces::srv::SetPose_Event_<ContainerAllocator> const>
...
// alias to use template instance with default allocator
using SetPose_Event =
  interfaces::srv::SetPose_Event_<std::allocator<void>>;
...
struct SetPose
{
  ...
  using Event = interfaces::srv::SetPose_Event;
};
