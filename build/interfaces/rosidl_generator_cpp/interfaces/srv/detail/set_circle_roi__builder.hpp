...
class Init_SetCircleROI_Event_response
{
public:
  explicit Init_SetCircleROI_Event_response(::interfaces::srv::SetCircleROI_Event & msg)
  : msg_(msg)
  {}
  ::interfaces::srv::SetCircleROI_Event response(::interfaces::srv::SetCircleROI_Event::_response_type arg)
  {
...
private:
  ::interfaces::srv::SetCircleROI_Event msg_;
};

class Init_SetCircleROI_Event_request
{
public:
  explicit Init_SetCircleROI_Event_request(::interfaces::srv::SetCircleROI_Event & msg)
  : msg_(msg)
  {}
  Init_SetCircleROI_Event_response request(::interfaces::srv::SetCircleROI_Event::_request_type arg)
  {
    msg_.request = std::move(arg);
    return Init_SetCircleROI_Event_response(msg_);
  }
...
class Init_SetCircleROI_Event_info
{
public:
  Init_SetCircleROI_Event_info()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_SetCircleROI_Event_request info(::interfaces::srv::SetCircleROI_Event::_info_type arg)
  {
    msg_.info = std::move(arg);
    return Init_SetCircleROI_Event_request(msg_);
  }
...
template<>
inline
auto build<::interfaces::srv::SetCircleROI_Event>()
{
  return interfaces::srv::builder::Init_SetCircleROI_Event_info();
}
