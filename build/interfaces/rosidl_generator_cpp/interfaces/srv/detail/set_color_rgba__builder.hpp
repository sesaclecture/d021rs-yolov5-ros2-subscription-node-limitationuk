...
class Init_SetColorRGBA_Event_response
{
public:
  explicit Init_SetColorRGBA_Event_response(::interfaces::srv::SetColorRGBA_Event & msg)
  : msg_(msg)
  {}
  ::interfaces::srv::SetColorRGBA_Event response(::interfaces::srv::SetColorRGBA_Event::_response_type arg)
  {
...
private:
  ::interfaces::srv::SetColorRGBA_Event msg_;
};

class Init_SetColorRGBA_Event_request
{
public:
  explicit Init_SetColorRGBA_Event_request(::interfaces::srv::SetColorRGBA_Event & msg)
  : msg_(msg)
  {}
  Init_SetColorRGBA_Event_response request(::interfaces::srv::SetColorRGBA_Event::_request_type arg)
  {
    msg_.request = std::move(arg);
    return Init_SetColorRGBA_Event_response(msg_);
  }
...
class Init_SetColorRGBA_Event_info
{
public:
  Init_SetColorRGBA_Event_info()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_SetColorRGBA_Event_request info(::interfaces::srv::SetColorRGBA_Event::_info_type arg)
  {
    msg_.info = std::move(arg);
    return Init_SetColorRGBA_Event_request(msg_);
  }
...
template<>
inline
auto build<::interfaces::srv::SetColorRGBA_Event>()
{
  return interfaces::srv::builder::Init_SetColorRGBA_Event_info();
}
