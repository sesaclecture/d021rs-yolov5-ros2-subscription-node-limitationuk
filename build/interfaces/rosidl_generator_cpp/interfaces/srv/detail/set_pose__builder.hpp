...
{
public:
  explicit Init_SetPose_Event_response(::interfaces::srv::SetPose_Event & msg)
  : msg_(msg)
  {}
  ::interfaces::srv::SetPose_Event response(::interfaces::srv::SetPose_Event::_response_type arg)
  {
...
private:
  ::interfaces::srv::SetPose_Event msg_;
};

class Init_SetPose_Event_request
{
public:
  explicit Init_SetPose_Event_request(::interfaces::srv::SetPose_Event & msg)
  : msg_(msg)
  {}
  Init_SetPose_Event_response request(::interfaces::srv::SetPose_Event::_request_type arg)
  {
...
public:
  ...
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_SetPose_Event_request info(::interfaces::srv::SetPose_Event::_info_type arg)
  {
...
template<>
inline
auto build<::interfaces::srv::SetPose_Event>()
{
  return interfaces::srv::builder::Init_SetPose_Event_info();
}
