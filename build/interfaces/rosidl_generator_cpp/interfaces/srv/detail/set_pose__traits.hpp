...
[[deprecated("use interfaces::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const interfaces::srv::SetPose_Event & msg,
  std::ostream & out, size_t indentation = 0)
{
  interfaces::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use interfaces::srv::to_yaml() instead")]]
inline std::string to_yaml(const interfaces::srv::SetPose_Event & msg)
{
  return interfaces::srv::to_yaml(msg);
}

template<>
inline const char * data_type<interfaces::srv::SetPose_Event>()
{
  return "interfaces::srv::SetPose_Event";
}

template<>
inline const char * name<interfaces::srv::SetPose_Event>()
{
  return "interfaces/srv/SetPose_Event";
}

template<>
struct has_fixed_size<interfaces::srv::SetPose_Event>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<interfaces::srv::SetPose_Event>
  : std::integral_constant<bool, has_bounded_size<interfaces::srv::SetPose_Request>::value && has_bounded_size<interfaces::srv::SetPose_Response>::value && has_bounded_size<service_msgs::msg::ServiceEventInfo>::value> {};

template<>
struct is_message<interfaces::srv::SetPose_Event>
  : std::true_type {};
