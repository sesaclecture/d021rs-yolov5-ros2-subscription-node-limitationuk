...
[[deprecated("use interfaces::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const interfaces::srv::SetString_Event & msg,
  std::ostream & out, size_t indentation = 0)
{
  interfaces::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use interfaces::srv::to_yaml() instead")]]
inline std::string to_yaml(const interfaces::srv::SetString_Event & msg)
{
  return interfaces::srv::to_yaml(msg);
}

template<>
inline const char * data_type<interfaces::srv::SetString_Event>()
{
  return "interfaces::srv::SetString_Event";
}

template<>
inline const char * name<interfaces::srv::SetString_Event>()
{
  return "interfaces/srv/SetString_Event";
}

template<>
struct has_fixed_size<interfaces::srv::SetString_Event>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<interfaces::srv::SetString_Event>
  : std::integral_constant<bool, has_bounded_size<interfaces::srv::SetString_Request>::value && has_bounded_size<interfaces::srv::SetString_Response>::value && has_bounded_size<service_msgs::msg::ServiceEventInfo>::value> {};

template<>
struct is_message<interfaces::srv::SetString_Event>
  : std::true_type {};
