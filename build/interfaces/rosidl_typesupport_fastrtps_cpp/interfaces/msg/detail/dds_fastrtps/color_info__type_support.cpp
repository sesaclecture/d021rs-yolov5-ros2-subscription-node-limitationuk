...
#include "interfaces/msg/detail/color_info__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const interfaces::msg::ColorInfo & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  interfaces::msg::ColorInfo & ros_message)
{
  // Member: color
  cdr >> ros_message.color;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = interfaces::msg::ColorInfo;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const interfaces::msg::ColorInfo *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<interfaces::msg::ColorInfo *>(
    untyped_ros_message);
...
static size_t _ColorInfo__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ColorInfo(full_bounded, is_plain, 0);
...
{
  return &interfaces::msg::typesupport_fastrtps_cpp::_ColorInfo__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interfaces, msg, ColorInfo)() {
  return &interfaces::msg::typesupport_fastrtps_cpp::_ColorInfo__handle;
}
