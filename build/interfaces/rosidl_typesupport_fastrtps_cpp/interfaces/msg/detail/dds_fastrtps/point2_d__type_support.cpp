...
#include "interfaces/msg/detail/point2_d__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const interfaces::msg::Point2D & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  interfaces::msg::Point2D & ros_message)
{
  // Member: width
  cdr >> ros_message.width;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = interfaces::msg::Point2D;
    is_plain =
      (
      offsetof(DataType, y) +
      last_member_size
...
{
  auto typed_message =
    static_cast<const interfaces::msg::Point2D *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<interfaces::msg::Point2D *>(
    untyped_ros_message);
...
{
  return &interfaces::msg::typesupport_fastrtps_cpp::_Point2D__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interfaces, msg, Point2D)() {
  return &interfaces::msg::typesupport_fastrtps_cpp::_Point2D__handle;
}
