...
static const _SetLineROI_Request_type_support_symbol_names_t _SetLineROI_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interfaces, srv, SetLineROI_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, interfaces, srv, SetLineROI_Request)),
  }
};
...
{
  return &::interfaces::srv::rosidl_typesupport_cpp::SetLineROI_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, interfaces, srv, SetLineROI_Request)() {
  return get_message_type_support_handle<interfaces::srv::SetLineROI_Request>();
}
...
static const _SetLineROI_Response_type_support_symbol_names_t _SetLineROI_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interfaces, srv, SetLineROI_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, interfaces, srv, SetLineROI_Response)),
  }
};
...
{
  return &::interfaces::srv::rosidl_typesupport_cpp::SetLineROI_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, interfaces, srv, SetLineROI_Response)() {
  return get_message_type_support_handle<interfaces::srv::SetLineROI_Response>();
}
...
typedef struct _SetLineROI_Event_type_support_ids_t
{
  const char * typesupport_identifier[2];
} _SetLineROI_Event_type_support_ids_t;

static const _SetLineROI_Event_type_support_ids_t _SetLineROI_Event_message_typesupport_ids = {
  {
    "rosidl_typesupport_fastrtps_cpp",  // ::rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
    "rosidl_typesupport_introspection_cpp",  // ::rosidl_typesupport_introspection_cpp::typesupport_identifier,
  }
...
typedef struct _SetLineROI_Event_type_support_symbol_names_t
{
  const char * symbol_name[2];
} _SetLineROI_Event_type_support_symbol_names_t;

#define STRINGIFY_(s) #s
#define STRINGIFY(s) STRINGIFY_(s)

static const _SetLineROI_Event_type_support_symbol_names_t _SetLineROI_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interfaces, srv, SetLineROI_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, interfaces, srv, SetLineROI_Event)),
  }
};

typedef struct _SetLineROI_Event_type_support_data_t
{
  void * data[2];
} _SetLineROI_Event_type_support_data_t;

static _SetLineROI_Event_type_support_data_t _SetLineROI_Event_message_typesupport_data = {
  {
    0,  // will store the shared library later
    0,  // will store the shared library later
  }
...
static const type_support_map_t _SetLineROI_Event_message_typesupport_map = {
  2,
  "interfaces",
  &_SetLineROI_Event_message_typesupport_ids.typesupport_identifier[0],
  &_SetLineROI_Event_message_typesupport_symbol_names.symbol_name[0],
  &_SetLineROI_Event_message_typesupport_data.data[0],
};

static const rosidl_message_type_support_t SetLineROI_Event_message_type_support_handle = {
  ::rosidl_typesupport_cpp::typesupport_identifier,
  reinterpret_cast<const type_support_map_t *>(&_SetLineROI_Event_message_typesupport_map),
  ::rosidl_typesupport_cpp::get_message_typesupport_handle_function,
...
{
  return &::interfaces::srv::rosidl_typesupport_cpp::SetLineROI_Event_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, interfaces, srv, SetLineROI_Event)() {
  return get_message_type_support_handle<interfaces::srv::SetLineROI_Event>();
}
...
static const _SetLineROI_type_support_symbol_names_t _SetLineROI_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interfaces, srv, SetLineROI)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, interfaces, srv, SetLineROI)),
  }
};
...
static const rosidl_service_type_support_t SetLineROI_service_type_support_handle = {
  ...
  ::rosidl_typesupport_cpp::get_message_type_support_handle<interfaces::srv::SetLineROI_Request>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<interfaces::srv::SetLineROI_Response>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<interfaces::srv::SetLineROI_Event>(),
...
{
  return &::interfaces::srv::rosidl_typesupport_cpp::SetLineROI_service_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_cpp, interfaces, srv, SetLineROI)() {
  return ::rosidl_typesupport_cpp::get_service_type_support_handle<interfaces::srv::SetLineROI>();
}
