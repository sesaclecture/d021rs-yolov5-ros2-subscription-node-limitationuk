...
ros_robot_controller_msgs__msg__ServoPosition__create(void)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ros_robot_controller_msgs__msg__ServoPosition * msg = (ros_robot_controller_msgs__msg__ServoPosition *)allocator.allocate(sizeof(ros_robot_controller_msgs__msg__ServoPosition), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(ros_robot_controller_msgs__msg__ServoPosition));
  bool success = ros_robot_controller_msgs__msg__ServoPosition__init(msg);
  if (!success) {
...
ros_robot_controller_msgs__msg__ServoPosition__destroy(ros_robot_controller_msgs__msg__ServoPosition * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    ros_robot_controller_msgs__msg__ServoPosition__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
ros_robot_controller_msgs__msg__ServoPosition__Sequence__init(ros_robot_controller_msgs__msg__ServoPosition__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ros_robot_controller_msgs__msg__ServoPosition * data = NULL;

  if (size) {
    data = (ros_robot_controller_msgs__msg__ServoPosition *)allocator.zero_allocate(size, sizeof(ros_robot_controller_msgs__msg__ServoPosition), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = ros_robot_controller_msgs__msg__ServoPosition__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        ros_robot_controller_msgs__msg__ServoPosition__fini(&data[i - 1]);
      }
...
ros_robot_controller_msgs__msg__ServoPosition__Sequence__fini(ros_robot_controller_msgs__msg__ServoPosition__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      ros_robot_controller_msgs__msg__ServoPosition__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ros_robot_controller_msgs__msg__ServoPosition__Sequence * array = (ros_robot_controller_msgs__msg__ServoPosition__Sequence *)allocator.allocate(sizeof(ros_robot_controller_msgs__msg__ServoPosition__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = ros_robot_controller_msgs__msg__ServoPosition__Sequence__init(array, size);
  if (!success) {
...
ros_robot_controller_msgs__msg__ServoPosition__Sequence__destroy(ros_robot_controller_msgs__msg__ServoPosition__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    ros_robot_controller_msgs__msg__ServoPosition__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
ros_robot_controller_msgs__msg__ServoPosition__Sequence__are_equal(const ros_robot_controller_msgs__msg__ServoPosition__Sequence * lhs, const ros_robot_controller_msgs__msg__ServoPosition__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!ros_robot_controller_msgs__msg__ServoPosition__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  ros_robot_controller_msgs__msg__ServoPosition__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(ros_robot_controller_msgs__msg__ServoPosition);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    ros_robot_controller_msgs__msg__ServoPosition * data =
      (ros_robot_controller_msgs__msg__ServoPosition *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!ros_robot_controller_msgs__msg__ServoPosition__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          ros_robot_controller_msgs__msg__ServoPosition__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!ros_robot_controller_msgs__msg__ServoPosition__copy(
