...
static const _SetBusServoState_type_support_symbol_names_t _SetBusServoState_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros_robot_controller_msgs, msg, SetBusServoState)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ros_robot_controller_msgs, msg, SetBusServoState)),
  }
};
...
{
  return &::ros_robot_controller_msgs::msg::rosidl_typesupport_cpp::SetBusServoState_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, ros_robot_controller_msgs, msg, SetBusServoState)() {
  return get_message_type_support_handle<ros_robot_controller_msgs::msg::SetBusServoState>();
}
