...
class Metaclass_GetBusServoState_Event(type):
    """Metaclass of message 'GetBusServoState_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'ros_robot_controller_msgs.srv.GetBusServoState_Event')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__get_bus_servo_state__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__get_bus_servo_state__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__get_bus_servo_state__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__get_bus_servo_state__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__get_bus_servo_state__event
...
class GetBusServoState_Event(metaclass=Metaclass_GetBusServoState_Event):
    """Message class 'GetBusServoState_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<ros_robot_controller_msgs/GetBusServoState_Request, 1>',
        'response': 'sequence<ros_robot_controller_msgs/GetBusServoState_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['ros_robot_controller_msgs', 'srv'], 'GetBusServoState_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['ros_robot_controller_msgs', 'srv'], 'GetBusServoState_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from ros_robot_controller_msgs.srv import GetBusServoState_Request
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, GetBusServoState_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'GetBusServoState_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from ros_robot_controller_msgs.srv import GetBusServoState_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, GetBusServoState_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'GetBusServoState_Response'"
...
class Metaclass_GetBusServoState(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _get_bus_servo_state.Metaclass_GetBusServoState_Event._TYPE_SUPPORT is None:
                _get_bus_servo_state.Metaclass_GetBusServoState_Event.__import_type_support__()
...
class GetBusServoState(metaclass=Metaclass_GetBusServoState):
    ...
    from ros_robot_controller_msgs.srv._get_bus_servo_state import GetBusServoState_Event as Event
