...
class MotorsState(metaclass=Metaclass_MotorsState):
    ...
    _fields_and_field_types = {
        'data': 'sequence<ros_robot_controller_msgs/MotorState>',
    }

    # This attribute is used to store an rosidl_parser.definition variable
    # related to the data type of each of the components the message.
    SLOT_TYPES = (
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['ros_robot_controller_msgs', 'msg'], 'MotorState')),  # noqa: E501
    )
