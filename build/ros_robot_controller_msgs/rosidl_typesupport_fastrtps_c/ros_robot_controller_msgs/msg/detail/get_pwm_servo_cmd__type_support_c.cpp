...
#include "ros_robot_controller_msgs/msg/detail/get_pwm_servo_cmd__rosidl_typesupport_fastrtps_c.h"
...
using _GetPWMServoCmd__ros_msg_type = ros_robot_controller_msgs__msg__GetPWMServoCmd;
...
{
  const _GetPWMServoCmd__ros_msg_type * ros_message = static_cast<const _GetPWMServoCmd__ros_msg_type *>(untyped_ros_message);
  (void)ros_message;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ros_robot_controller_msgs__msg__GetPWMServoCmd;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const ros_robot_controller_msgs__msg__GetPWMServoCmd * ros_message = static_cast<const ros_robot_controller_msgs__msg__GetPWMServoCmd *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_ros_robot_controller_msgs__msg__GetPWMServoCmd(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  ros_robot_controller_msgs__msg__GetPWMServoCmd * ros_message = static_cast<ros_robot_controller_msgs__msg__GetPWMServoCmd *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_ros_robot_controller_msgs__msg__GetPWMServoCmd(cdr, ros_message);
}

static uint32_t _GetPWMServoCmd__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ros_robot_controller_msgs__msg__GetPWMServoCmd(
...
static size_t _GetPWMServoCmd__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ros_robot_controller_msgs__msg__GetPWMServoCmd(
...
static message_type_support_callbacks_t __callbacks_GetPWMServoCmd = {
...
static rosidl_message_type_support_t _GetPWMServoCmd__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_GetPWMServoCmd,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ros_robot_controller_msgs, msg, GetPWMServoCmd)() {
  return &_GetPWMServoCmd__type_support;
}
