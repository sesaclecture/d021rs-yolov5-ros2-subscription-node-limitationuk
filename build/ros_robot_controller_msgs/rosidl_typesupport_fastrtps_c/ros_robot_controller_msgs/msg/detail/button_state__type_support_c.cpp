...
bool cdr_serialize_ros_robot_controller_msgs__msg__ButtonState(
  const ros_robot_controller_msgs__msg__ButtonState * ros_message,
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ros_robot_controller_msgs
bool cdr_deserialize_ros_robot_controller_msgs__msg__ButtonState(
  eprosima::fastcdr::Cdr & cdr,
  ros_robot_controller_msgs__msg__ButtonState * ros_message)
{
  // Field name: id
  {
    cdr >> ros_message->id;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ros_robot_controller_msgs
bool cdr_serialize_key_ros_robot_controller_msgs__msg__ButtonState(
  const ros_robot_controller_msgs__msg__ButtonState * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: id
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ros_robot_controller_msgs
size_t get_serialized_size_key_ros_robot_controller_msgs__msg__ButtonState(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _ButtonState__ros_msg_type * ros_message = static_cast<const _ButtonState__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ros_robot_controller_msgs
size_t max_serialized_size_key_ros_robot_controller_msgs__msg__ButtonState(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const ros_robot_controller_msgs__msg__ButtonState * ros_message = static_cast<const ros_robot_controller_msgs__msg__ButtonState *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_ros_robot_controller_msgs__msg__ButtonState(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  ros_robot_controller_msgs__msg__ButtonState * ros_message = static_cast<ros_robot_controller_msgs__msg__ButtonState *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_ros_robot_controller_msgs__msg__ButtonState(cdr, ros_message);
}
