...
static const _GetBusServoState_Event_type_support_symbol_names_t _GetBusServoState_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ros_robot_controller_msgs, srv, GetBusServoState_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ros_robot_controller_msgs, srv, GetBusServoState_Event)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, ros_robot_controller_msgs, srv, GetBusServoState_Event)() {
  return &::ros_robot_controller_msgs::srv::rosidl_typesupport_c::GetBusServoState_Event_message_type_support_handle;
}
...
static const rosidl_service_type_support_t GetBusServoState_service_type_support_handle = {
  ...
  &GetBusServoState_Request_message_type_support_handle,
  &GetBusServoState_Response_message_type_support_handle,
  &GetBusServoState_Event_message_type_support_handle,
